          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  'Print this QR code and attach it to the clothing item',
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    onPressed: () {
                      // In a real app, this would trigger a save or share function
                      _ttsService.speak(
                          "QR code ready. In a real app, you would be able to save or share this QR code.");
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content:
                                Text('QR code ready for saving or sharing')),
                      );
                    },
